...
function showNavbar(){
  ...
  header.innerHTML='<nav><a href="index.html"><img src="img/logo.png" alt="LMR" style="width:100%; max-width:150px;"></a><div><ul class="right"><li><a class="nav_list" href="index.html"><br>Home</a></li><li class="dropdown"><a href="javascript:void(0);" class="nav_list"><br/>Info ▼ </a><div class="dropdown-content"><a href="about.html">About</a><a href="contact.html">Contact us</a></div></li><li><a class="nav_list" href="gallery.html"><br/>Gallery</a></li><li><a class="nav_list" href="news.html"><br/>News</a></li><li><a class="nav_list" href="events.html"><br/>Events</a></li><li><a class="nav_list" href="calendar.html"><br/>Calendar</a></li><li><form action="join.html"><br/><input class="button abtn nav_list" type="submit" value="Join us!"/></form></li><li><a href="javascript:void(0);" class="abtn icon" onclick="myFunction()">&#9776;</a></li></ul></div></nav>'+'<div id="mobile"><ol><li><a href="index.html"><br/>Home</a></li><li class="dropdownmb"><a><span><label for="drop-1" class="toggle"><br/>Info ▼ </label></span></a><input type="checkbox" id="drop-1"><div class="dropdown-contentmb"><a href="about.html">About</a><a href="contact.html">Contact us</a></div></li><li><a href="gallery.html"><br/>Gallery</a></li><li><a href="news.html"><br/>News</a></li><li><a href="events.html"><br/>Events</a></li><li><a href="calendar.html"><br/>Calendar</a></li><li><form action="join.html"><br/><input class="button" type="submit" value="Join us!"/></form></li></ol></div>';
}
showNavbar()
