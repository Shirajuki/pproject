const calendar = [
	...
	{ type: "event", title: "Party at mine", informasjon: "It's that time of year again! No, not Christmas (yet). ITS HALLOWEEN. THE SPOOKIES TIME OF YEAR. And it's time to party. It's my honor to invite the entire team  home to me and party the spooky night away into christmas! \n" +"Dress code: costumes (spooky or sexy or funny, everyone is accepted)", dato: "2019-10-31", tid: "19:00", sted: "Harald Gress' Home", link:"javascript:void(0)", tag: "Social" },
	{ type: "event", title: "Lets make some money", informasjon: "Time to make some money for this rockin' team!\n" +"During this Sunday a fundraiser will be held. We'll sell cakes, waffles, coffee and 'lodd' where you can win some sweet prices! Invite your friends and family. Hope to see you there. ", dato: "2019-10-30", tid: "18:00", sted: "Gløshaugen", link:"javascript:void(0)", tag: "Fundraiser" },
	{ type: "event", title: "Big competition in Oslo", informasjon: "The coming week there will be held the annual Norwegian Winter Lawnracers Race  (NWLR) for the 3rd time. The group registered to compete will travel together by train on Friday, whilst the lawnmowers will be shipped in a big trailer (like in Cars, the movie). When we arrive in Oslo, will go to the hotel together (unless you have somewhere else to sleep), and have a \"quiet\" night in. The weekend will be dedicated to racing and some socializing.  A party can be guaranteed! Hope to see you there :)", dato: "2019-11-15", tid: "18:00", sted: "Oslo", link:"javascript:void(0)", tag: "Competition" },
